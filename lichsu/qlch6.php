                          ...
                          <table class="table-bordered" width="1220" >
                            <nav aria-label="...">
                              ...
                              // ngược lại hiển thị thẻ a
                                  if ($i == $current_page){
                                    echo '<li class="page-item active"><a class="page-link" href="qlch2.php?page='.$i.'">'.$i.'</a></li>';
                                  }
                                  else{
                                    echo '<li class="page-item"><a class="page-link" href="qlch2.php?page='.$i.'">'.$i.'</a></li>';
                                  }
                                }
                                if ($current_page < $total_page && $total_page > 1){
                                  echo '<li class="page-item"><a class="page-link" href="qlch2.php?page='.($current_page+1).'">'."Next".'</a></li>';
                                }
                                ?>
                              </ul>
                            </nav>
