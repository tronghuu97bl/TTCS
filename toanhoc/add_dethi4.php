...
if($_SERVER['REQUEST_METHOD'] != 'POST'){
    header('location: '. $ADMIN_URL .'toanhoc/add_dethi3.php');
    die;
}
$ten = $_POST['ten'];
$ngaytao = date("Y/m/d");
