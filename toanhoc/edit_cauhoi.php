...
$sql = "SELECT * FROM cauhoi_toan where id_cauhoi = $id";
                      ...
                      <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="xuli_edit_cauhoi.php" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            if ($kq['hinhkhonggian']>0) {
                              $loaicau_cu=6;
                            }
                            if ($kq['hephuongtrinh']>0) {
                              $loaicau_cu=7;
                            }
                            if ($kq['batphuongtrinh']>0) {
                              $loaicau_cu=8;
                            }
                            if ($kq['tohop_sacxuat']>0) {
                              $loaicau_cu=9;
                            }
                            if ($kq['oxyz']>0) {
                              $loaicau_cu=10;
                            ...
                            <select class="form-control" name="loaicau" id="exampleSelectGender">
                              <option value="1" <?php if($kq['hamso'] > 0){ echo 'selected'; } ?>>Hàm Số</option>
                              <option value="2" <?php if($kq['logarit'] > 0){ echo 'selected'; } ?>> logarit</option>
                              <option value="3" <?php if($kq['nguyenham_tichphan'] > 0){ echo 'selected'; } ?>> Nguyên Hàm - Tích Phân </option>
                              <option value="4" <?php if($kq['sophuc'] > 0){ echo 'selected'; }  ?>> Số Phức</option>
                              <option value="5" <?php if($kq['luonggiac'] > 0){ echo 'selected'; }  ?>> Lượng Giác</option>
                              <option value="6" <?php if($kq['hinhkhonggian'] > 0){ echo 'selected'; }  ?>> Hình Không Gian</option>
                              <option value="7" <?php if($kq['hephuongtrinh'] > 0){ echo 'selected'; }  ?>> Hệ Phương Trình</option>
                              <option value="8" <?php if($kq['batphuongtrinh'] > 0){ echo 'selected'; }  ?>> Bất Phương Trình</option>
                              <option value="9" <?php if($kq['tohop_sacxuat'] > 0){ echo 'selected'; }  ?>> Tổ Hợp - Sác Xuất </option>
                              <option value="10" <?php if($kq['oxyz'] > 0){ echo 'selected'; }  ?>> Mặt Phẳng Oxyz </option>
                            </select>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div>
                              <?php if ($kq['hinhanh']=="") {
                                echo "<img width='200px' height='150px' src='../img/toanhoc/default.jpg'>";
                              } else {
                          ...
                          <button type="button" class="btn btn-light" onclick="location.href='<?= $ADMIN_URL?>toanhoc/qlch1.php?page=<?=$page?>'">Cancel</button>
                        </form>
                      </div>
                    </div>
                  </div>
