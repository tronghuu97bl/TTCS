                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <?php foreach ($kq as $key): ?>
                            ...
                            <td width="25px"><button type="button" class="btn-sm btn-gradient-primary btn-rounded btn-fw">Sửa</button></td>
                            <td width="25px"> <button type="button" class="btn-sm btn-gradient-primary btn-rounded btn-fw">Xóa</button> </td>
                          </tr>
