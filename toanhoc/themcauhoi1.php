                    ...
                    <form class="forms-sample" method="post" action="xuli_add_cauhoi.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="loaicau" id="exampleSelectGender">
                          <option value="1"> Hàm Số</option>
                          <option value="2"> Logarit</option>
                          <option value="3"> Nguyên Hàm - Tích Phân</option>
                          <option value="4"> Số Phức</option>
                          <option value="5"> Lượng Giác</option>
                          <option value="6"> Hình Không Gian</option>
                          <option value="7"> Hệ Phương Trình</option>
                          <option value="8"> Bất Phương Trình</option>
                          <option value="9"> Tổ Hợp - Xác Suất</option>
                          <option value="10"> Mặt Phẳng Oxyz</option>
                        </select>
                      </div>
                      <div class="form-group">
