                    ...
                    <form class="forms-sample" method="post" action="xuli_add_cauhoi.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="loaicau" id="exampleSelectGender">
                          <option value="1"> Dao động</option>
                          <option value="2"> Sóng Cơ</option>
                          <option value="3"> Mạch điện</option>
                          <option value="4"> Mạch giao động</option>
                          <option value="5"> Sóng ánh sáng</option>
                          <option value="6"> Lượng tử</option>
                          <option value="7"> Hạt nhân</option>
