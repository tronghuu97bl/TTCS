...
$sql = "select * from de_ly limit $start, $limit";
                            ...
                            <nav aria-label="...">
                              <ul class="pagination">
                                ...
                                if ($current_page > 1 && $total_page > 1){ 
                                  echo '<li class="page-item"><a class="page-link" href="qldethi2.php?page='.($current_page-1).'">'."Previous".'</a></li>';
                                }
                                for ($i = 1; $i <= $total_page; $i++){
                              // Nếu là trang hiện tại thì hiển thị thẻ span
                              // ngược lại hiển thị thẻ a
                                  if ($i == $current_page){
                                    echo '<li class="page-item active"><a class="page-link" href="qldethi2.php?page='.$i.'">'.$i.'</a></li>';
                                  }
                                  else{
                                    echo '<li class="page-item"><a class="page-link" href="qldethi2.php?page='.$i.'">'.$i.'</a></li>';
                                  }
                                }
                                if ($current_page < $total_page && $total_page > 1){
                                  echo '<li class="page-item"><a class="page-link" href="qldethi2.php?page='.($current_page+1).'">'."Next".'</a></li>';
                                }
                                ?>
                              </ul>
                            </nav>
                            ...
                            <tbody>
                              <?php foreach ($kq as $key): ?>
                                <tr>
                                  ...
                                  <td><button type="button" class="btn-sm btn-gradient-primary btn-rounded btn-fw" onclick="location.href='<?= $ADMIN_URL?>vatli/view_dethi2.php?id=<?= $key['id_de']?>'" >Xem</button></td>
                                  <td> <button class="btn-sm btn-gradient-primary btn-rounded btn-fw btn-remove" href="javascript:;" linkurl="<?= $ADMIN_URL?>vatli/xoa_dethi.php?id=<?= $key['id_de']?>">xóa</button> </td>
                                </tr>
