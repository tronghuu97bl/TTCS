...
$id_de = $_GET['id'];
$page = $_GET['page'];
$sql = "SELECT * from de_ly where id_de = $id_de";
...
$idc39 = $run['idcau39'];
$idc40 = $run['idcau40'];
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc1";
$kq1 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc2";
$kq2 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc3";
$kq3 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc4";
$kq4 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc5";
$kq5 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc6";
$kq6 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc7";
$kq7 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc8";
$kq8 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc9";
$kq9 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc10";
$kq10 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc11";
$kq11 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc12";
$kq12 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc13";
$kq13 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc14";
$kq14 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc15";
$kq15 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc16";
$kq16 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc17";
$kq17 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc18";
$kq18 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc19";
$kq19 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc20";
$kq20 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc21";
$kq21 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc22";
$kq22 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc23";
$kq23 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc24";
$kq24 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc25";
$kq25 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc26";
$kq26 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc27";
$kq27 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc28";
$kq28 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc29";
$kq29 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc30";
$kq30 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc31";
$kq31 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc32";
$kq32= getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc33";
$kq33 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc34";
$kq34 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc35";
$kq35 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc36";
$kq36 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc37";
$kq37 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc38";
$kq38 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc39";
$kq39 = getSimpleQuery($sql);
$sql = "SELECT * from cauhoi_ly where id_cauhoi = $idc40";
