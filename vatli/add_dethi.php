...
$sql="SELECT * FROM cauhoi_ly WHERE daodong > 0 ORDER by rand() limit 7";
$sc1=getSimpleQuery($sql, true);
$sql="SELECT * FROM `cauhoi_ly` WHERE songco > 0 ORDER by rand() limit 5";
$sc2=getSimpleQuery($sql, true);
$sql="SELECT * FROM `cauhoi_ly` WHERE dien > 0 ORDER by rand() limit 7";
$sc3=getSimpleQuery($sql, true);
$sql="SELECT * FROM `cauhoi_ly` WHERE machgiaodong > 0 ORDER by rand() limit 3";
$sc4=getSimpleQuery($sql, true);
$sql="SELECT * FROM `cauhoi_ly` WHERE songanhsang > 0 ORDER by rand() limit 5";
$sc5=getSimpleQuery($sql, true);
$sql="SELECT * FROM `cauhoi_ly` WHERE luongtu > 0 ORDER by rand() limit 4";
$sc6=getSimpleQuery($sql, true);
$sql="SELECT * FROM `cauhoi_ly` WHERE hatnhan > 0 ORDER by rand() limit 5";
$sc7=getSimpleQuery($sql, true);
$sql="SELECT * FROM `cauhoi_ly` WHERE vatly11 > 0 ORDER by rand() limit 4";
