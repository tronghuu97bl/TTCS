...
if ($filename != "") {
    ...
    $sql="insert into cauhoi_dia(ma_monhoc, ngaythem, cauhoi, dapanA, dapanB, dapanC, dapanD, dapandung, dokho, hinhanh) values (5,'$ngaythem','$noidung','$dapanA','$dapanB','$dapanC','$dapanD',$dapandung,$dokho,'$filename')";
    $run=getSimpleQuery($sql);
    header('location: '. $ADMIN_URL . 'diali/themcauhoi7.php?success=true');
    die;
    ?>