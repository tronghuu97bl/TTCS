...
$sql = "SELECT * FROM cauhoi_dia where id_cauhoi = $id";
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="xuli_edit_cauhoi.php" enctype="multipart/form-data">
                          ...
                          <button type="button" class="btn btn-light" onclick="location.href='<?=$ADMIN_URL?>diali/qlch7.php?page=<?=$page?>'">Cancel</button>
                        </form>
                      </div>
                    </div>
                  </div>
