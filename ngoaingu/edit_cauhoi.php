...
$sql = "SELECT * FROM cauhoi_ta where id_cauhoi = $id";
                        ...
                        <form class="forms-sample" method="post" action="xuli_edit_cauhoi.php" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="loaicau" id="exampleSelectGender">
                              <option value="1" <?php if($kq['nguam'] > 0){ echo 'selected'; } ?>> Ngữ Âm</option>
                              <option value="2" <?php if($kq['nguphap_tuvung'] > 0){ echo 'selected'; } ?>> Ngữ Pháp - Từ Vựng</option>
                              <option value="3" <?php if($kq['giaotiep'] > 0){ echo 'selected'; } ?>> Giao Tiếp</option>
                              <option value="4" <?php if($kq['kynangdoc'] > 0){ echo 'selected'; }  ?>> Kỹ Năng Đọc</option>
                              <option value="5" <?php if($kq['kynangviet'] > 0){ echo 'selected'; }  ?>> Kỹ Năng Viết</option>
                            </select>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div>
                              <?php if ($kq['hinhanh']=="") {
                                echo "<img width='200px' height='150px' src='../img/tienganh/default.jpg'>";
                              } else {
                          ...
                          <button type="button" class="btn btn-light" onclick="location.href='<?=$ADMIN_URL?>ngoaingu/qlch4.php?page=<?=$page?>'">Cancel</button>
                        </form>
                      </div>
                    </div>
                  </div>
