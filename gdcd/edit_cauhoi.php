...
$sql = "SELECT * FROM cauhoi_gdcd where id_cauhoi = $id";
                      ...
                      <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="xuli_edit_cauhoi.php" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <div>
                              <?php if ($kq['hinhanh']=="") {
                                echo "<img width='200px' height='150px' src='../img/gdcd/default.jpg'>";
                              } else {
                          ...
                          <button type="button" class="btn btn-light" onclick="location.href='<?=$ADMIN_URL?>gdcd/qlch8.php?page=<?=$page?>'">Cancel</button>
                        </form>
                      </div>
                    </div>
                  </div>
