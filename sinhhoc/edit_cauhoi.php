...
$sql = "SELECT * FROM cauhoi_sinh where id_cauhoi = $id";
                        ...
                        <form class="forms-sample" method="post" action="xuli_edit_cauhoi.php" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="loaicau" id="exampleSelectGender">
                              <option value="1" <?php if($kq['s1'] > 0){ echo 'selected'; } ?>>Cơ Chế Di Truyền Và Biến Dị</option>
                              <option value="2" <?php if($kq['s2'] > 0){ echo 'selected'; } ?>>Tính quy luật của hiện tượng di truyền</option>
                              <option value="3" <?php if($kq['s3'] > 0){ echo 'selected'; } ?>>Di truyền học quần thể</option>
                              <option value="4" <?php if($kq['s4'] > 0){ echo 'selected'; }  ?>>Ứng dụng di truyền học vào chọn giống </option>
                              <option value="5" <?php if($kq['s5'] > 0){ echo 'selected'; }  ?>>Di truyền học người</option>
                              <option value="6" <?php if($kq['s6'] > 0){ echo 'selected'; }  ?>>Tiến hóa</option>
                              <option value="7" <?php if($kq['s7'] > 0){ echo 'selected'; }  ?>>Sinh thái Học</option>
                              <option value="8" <?php if($kq['s8'] > 0){ echo 'selected'; }  ?>>Chuyển hóa vật chất và năng lượng</option>
                            </select>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div>
                              <?php if ($kq['hinhanh']=="") {
                                echo "<img width='200px' height='150px' src='../img/sinhhoc/default.jpg'>";
                              } else {
                          ...
                          <button type="button" class="btn btn-light" onclick="location.href='<?= $ADMIN_URL?>toanhoc/qlch5.php?page=<?=$page?>'">Cancel</button>
                        </form>
                      </div>
                    </div>
                  </div>
